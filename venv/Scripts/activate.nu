...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Robin icika\PycharmProjects\afternoonBootstrapProject\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Robin icika\PycharmProjects\afternoonBootstrapProject\venv\Scripts\deactivate.nu'
